...
const apiLink = "https://rinkeby.infura.io/v3/aee4dd30db8a42aa935d0f714ee521ae";
...
/// add mnemonics
    ...
    render()
    {
        ...
        return (
            ...
            <div>
                <h2>Did you forget a word or two of your Ethereum seed phrase?</h2>
    ...
    <InputLabel htmlFor="age-native-required"> Word # I don't remember</InputLabel>
        ...
        <FormHelperText>Required</FormHelperText>
                ...
                {this.state.seeData === true ? (
                    <div>
                      {this.state.loader < 99 ?  <CircularProgress variant="static" value={this.state.loader} /> : <span />}
                        <div>
                            {this.state.loader < 99 ? (<div>                        Analyzing 2048 possible seed phrases...
                            If anything is found it will appear here. </div>) : <div>Finished</div> }
