...
generateMnemonic24 = async() => {
  try{
    ...
    <InputLabel htmlFor="age-native-required"> <a href="https://metasafe.org/terms" target="_blank"  rel='noopener noreferrer'>Terms & Conditions</a></InputLabel>
        <Select
          native
...
: <span /> }
 ...
 <Typography variant="subtitle1" gutterBottom>
          Are you an exchange, wallet or other company and need many safe mnemonics for your users? 
           ...
           <a href="https://metasafe.org" target="_blank" rel='noopener noreferrer'>Click here</a>
          </Typography>
