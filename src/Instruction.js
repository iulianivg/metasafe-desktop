...
<br />
    ...
    Paste your API link. Select the word you don't remember and write your seed phrases. Click on "Recover Seed Phrase" and wait a few seconds. 
      ...
      <p style={{textAlign:'left'}}>
       If you download your own blockchain node it is recommended to store data on SSD rather than HDD. HDD storage will slow down the process exponentially. Hardware Recommendation:
       <ul> 
           <li>4GB RAM DDR4 </li> 
           <li>At least Dual-Core CPU</li>
           <li>Don't do intensive tasks on your computer when using this tool</li>
           </ul> 
            </p>
      <br /> <br /> <br />
      <Typography variant="h6" style={{fontWeight:'bold', textAlign:'left',color:'#3f51b5'}} gutterBottom>
